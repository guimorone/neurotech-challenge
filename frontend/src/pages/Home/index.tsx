...
import { INITIAL_AMOUNT, INITIAL_CHECK_PERIOD, CURRENCIES } from '../../constants';
					...
					<div className="flex flex-col md:flex-row gap-8 items-center justify-center">
							...
							<div className="space-y-2 w-fit">
								...
								>
									{CURRENCIES.map((currency, index) => (
										<option
											key={`base-${currency}-${index}`}
											value={currency}
											disabled={currency == currentBaseCurrency}
										>
											{currency}
										</option>
									))}
						...
						<div className="space-y-2">
							<div className="space-y-2 w-fit">
								...
								>
									{CURRENCIES.map((currency, index) => (
										<option key={`to-${currency}-${index}`} value={currency} disabled={currency == currentToCurrency}>
											{currency}
										</option>
									))}
								</select>
